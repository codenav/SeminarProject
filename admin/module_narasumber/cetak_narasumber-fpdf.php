...
// Nama Kolom Heading
$header = array('No', 'kode Narasumber', 'Nama Narasumber','Gelar','Alamat Narasumber','Pekerjaan','Umur','Jenis Kelamin','Telepon/HP','E-Mail');
...
// Data loading
$query="select kode_narasumber,nama_narsumber,gelar,alamat_narasumber,pekerjaan,umur,jenis_kelamin,telepon,email from narasumber";
