<div class="modal fade" id="tambah_data" role="dialog">
  <div class="modal-dialog">
    ...
    <form class="form-horizontal" method="POST" action="module_narasumber/action_narasumber.php">
        <div class="modal-header">
          <p><i class="fa fa-user-plus"></i> Tambah</p>
        </div>
        <div class="modal-body">
            <div class="form-group">
              <label for="admin-usr" class="col-lg-4 control-label"> Kode Narasumber : </label>
              <div class="col-lg-8">
                <input type="text" class="form-control" name="kode_narasumber" placeholder="Kode Narasumber">
              </div>
            </div>
            <div class="form-group">
              <label for="admin-name" class="col-lg-4 control-label">Nama Narasumber : </label>
              <div class="col-lg-8">
                <input type="text" class="form-control" name="nama" placeholder="Nama Narasumber">
              </div>
            </div>
             <div class="form-group">
             ...
             <div class="form-group">
               <label for="admin-name" class="col-lg-4 control-label"> Alamat Narasumber : </label>
               <div class="col-lg-8">
                 <input type="text" class="form-control" name="alamat" placeholder="Alamat Narasumber">
               </div>
             </div>
             <div class="form-group">
