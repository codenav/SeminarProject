...
// Nama Kolom Heading
$header = array('No', 'Kode Seminar', 'Tema','Nama Seminar','Penyelenggara','Waktu','Kapasitas');

// Data loading
$query="select kode_seminar,tema,nama_lengkap,penyelenggara,waktu,kapasitas from seminar";
