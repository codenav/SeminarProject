...
// Nama Kolom Heading
$header = array('No', 'kode Tamu', 'Nama Tamu','Gelar','Alamat Tamu','Pekerjaan','Umur','Jenis Kelamin','Telepon/HP','E-Mail');

// Data loading
$query="select kode_tamu,nama_tamu,gelar,alamat_tamu,pekerjaan,umur,jenis_kelamin,telepon,email from tamu";
